# UI Block Specifications — Indice
...
| # | Nome | File |
|---|---|---|
| BLOCK-001 | Asymmetric media collage | loop-post-editoriali.md |
| BLOCK-002 | Horizontal discovery rail + suggestion list | loop-categorie.md |
| BLOCK-003 | Two-column results grid | loop-prodotti.md |
| BLOCK-004 | People suggestion carousel | loop-post-editoriali.md |
| BLOCK-005 | Editorial stacked banner stack | banner-promo.md |
| BLOCK-006 | Accordion footer nav | navigation.md |
| BLOCK-007 | Destination detail card | loop-prodotti.md |
| BLOCK-008 | Filtered category carousel con frecce prev/next | loop-categorie.md |
| BLOCK-009 | Category showcase numerato | loop-categorie.md |
| BLOCK-010 | Sliding panel navigation (drill-down) | navigation.md |
